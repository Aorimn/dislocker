...
#define DIS_RET_ERROR_DATASET_CHECK -24
#define DIS_RET_ERROR_VMK_RETRIEVAL -25
#define DIS_RET_ERROR_FVEK_RETRIEVAL -26
#define DIS_RET_ERROR_VIRTUALIZATION_INFO_DATUM_NOT_FOUND -27
